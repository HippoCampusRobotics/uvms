...
class KFInterface {
 ...
 protected:
  ...
  virtual rcl_interfaces::msg::SetParametersResult onSetNoiseParamCallback(
...
class KFLinearInterface : public KFInterface {
 ...
 private:
  ...
  rcl_interfaces::msg::SetParametersResult onSetNoiseParamCallback(
...
class KFFeedforwardInterface : public KFInterface {
 ...
 private:
  ...
  rcl_interfaces::msg::SetParametersResult onSetMovingAverageParamCallback(
