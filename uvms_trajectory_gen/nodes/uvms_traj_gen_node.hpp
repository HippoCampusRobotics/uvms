...
namespace uvms_traj_gen {
    ...
    //! This class generates endeffector trajectories in the inertial coordinate system, meaning that position, velocity and acceleration
    //! as well as angular velocity and acceleration vectors are represented in the inertial coordinate system. Attitude describes rotation between
    //! inertial coordinate system and body coordinate system
    ...
    private:
        ...
        rclcpp::Publisher<uvms_msgs::msg::ControlTargetPrediction>::SharedPtr eef_traj_pub_prediction_;
        rclcpp::Publisher<geometry_msgs::msg::Vector3>::SharedPtr angular_vel_debug_pub_;
        rclcpp::Subscription<geometry_msgs::msg::PoseStamped>::SharedPtr pose_eef_sub_;
