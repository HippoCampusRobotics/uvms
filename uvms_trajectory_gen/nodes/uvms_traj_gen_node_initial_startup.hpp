...
namespace uvms_traj_gen{
    ...
    public:
        ...
        void setTrajStatusPtr(int* status_ptr){
            status_ptr_ = status_ptr;
        }

        void setTrajStatusPublisherPtr(const rclcpp::Publisher<std_msgs::msg::Int64>::SharedPtr &status_pub){
    ...
    private:
        ...
        void updateManipulatorStates(const sensor_msgs::msg::JointState::SharedPtr msg);
        ...
        rclcpp::Subscription<sensor_msgs::msg::JointState>::SharedPtr state_manipulator_sub_;
        ...
        uvms_common::p2p_trajectory::State2StateTrajectory<param_utils::n_active_joints> initial_manipulator_traj_;
