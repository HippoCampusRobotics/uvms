...
def generate_launch_description():
    ...
    trajectory_type = launch.substitutions.LaunchConfiguration(
        'trajectory_type'
    )
    ...
    motion_planning_node = launch_ros.actions.Node(
        package='bluerov_trajectory_gen',
        executable='trajectory_gen_node',
        namespace=vehicle_name,
        parameters=[
            {'trajectory_type': trajectory_type, 'use_sim_time': use_sim_time},
            config_file_path,
        ],
        output='screen',
    )
