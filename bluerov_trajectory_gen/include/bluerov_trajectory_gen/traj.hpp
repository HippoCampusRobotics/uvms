...
namespace bluerov_traj_gen {
    ...
    public:
        ...
        virtual void getSetpointMsg(const double &t, hippo_msgs::msg::ControlTarget &out) = 0;
    ...
    public:
        ...
        void getSetpointMsg(const double &t, hippo_msgs::msg::ControlTarget &out) override;
        void setPositionPtr(Eigen::Vector3d* pos_ptr){
            pos_ptr_ = pos_ptr;
        }
        void setAttitudePtr(Eigen::Quaterniond* att_ptr){
            att_ptr_ = att_ptr;
        }
    ...
    private:
        ...
        bool* started_loop_ptr_; //!< pointer to the flag of the trajectory node, can be set to falsed when limit is reached to drive back to start
        bool* gen_start_traj_ptr_; //!< pointer to the flag of the trajectory node, can be set to falsed when limit is reached to drive back to start
