...
namespace bluerov_ctrl {
    TwistPIDControl::TwistPIDControl(bool body_fixed) {
        body_fixed_ = body_fixed;
    }

    //! expects velocity target in body frame
    void TwistPIDControl::setVelocityTarget(const double &lin_x, const double &lin_y, const double &lin_z, const double &ang_x,
    ...
    void TwistPIDControl::setAccelerationTarget(const double &lin_x, const double &lin_y, const double &lin_z, const double &ang_x,
                                                       const double &ang_y, const double &ang_z) {
    ...
    void TwistPIDControl::update(const double &dt, const Eigen::Quaterniond &att, const Eigen::Vector3d &vel,
        ...
        d_component_ = d_gains_ * (int(d_use_accel_feedforward_) * dnu_des_ - int(d_use_accel_estimation_) * dnu);
        if (body_fixed_) {
