...
def generate_launch_description():
    ...
    mixer_path = str(low_level_ctrl_package_path / "launch/node_actuator_mixer_bluerov.launch.py")
    mixer_config_file_path = str(low_level_ctrl_package_path / ('config/actuator_mixer_bluerov_advanced.yaml'))
    ...
    estimation_watchdog_path = str(ctrl_package_path / "launch/node_estimation_drift_watchdog.launch.py")
    ...
    traj_gen_path = str(get_package_share_path('bluerov_trajectory_gen') / "launch/node_trajectory_gen.launch.py")
    ...
    model_path_rviz = str(sim_package_path / 'models/bluerov/urdf/bluerov_rviz.xacro')
                                                ...
                                                parameters=[{'use_sim_time': use_sim_time,
                                                             'robot_description': launch_ros.descriptions.ParameterValue(
                                                                 launch.substitutions.Command(
                                                                     ['xacro ', model_path_rviz, " vehicle_name:=",
                                                                      vehicle_name]),
    ...
    launch_files.append(launch.actions.IncludeLaunchDescription(
        ...
        launch_arguments=dict(visualization_modules="[2, 3, 4, 5, 6, 9]",
