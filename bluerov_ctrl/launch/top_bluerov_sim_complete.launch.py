...
def generate_launch_description():
    ...
    velocity_ctrl_path = str(
        ctrl_package_path / 'launch/node_velocity_control.launch.py'
    )
    ctrl_config_path = str(ctrl_package_path / 'config/ctrl_params_sim.yaml')
    pose_ctrl_module_path = str(
        ctrl_package_path / 'launch/node_pose_control_module.launch.py'
    )
    ...
    estimation_path = str(
        estimation_package_path / 'launch/estimation.launch.py'
    )
    traj_gen_path = str(
        get_package_share_path('bluerov_trajectory_gen')
        / 'launch/node_trajectory_gen.launch.py'
    )
    visualization_package_path = get_package_share_path('uvms_visualization')
    visualization_path = str(
        visualization_package_path / 'launch/visualization.launch.py'
    )
    rviz_path = str(ctrl_package_path / 'launch/rviz.launch.py')
    model_path_rviz = str(
        sim_package_path / 'models/bluerov/urdf/bluerov_rviz.xacro'
    )
