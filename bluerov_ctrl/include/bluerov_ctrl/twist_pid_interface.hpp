...
#ifndef BLUEROV_CTRL_TWIST_PID_INTERFACE_HPP
#define BLUEROV_CTRL_TWIST_PID_INTERFACE_HPP
...
class TwistPIDInterface {
 public:
  TwistPIDInterface() = default;
 ...
 private:
  ...
  rcl_interfaces::msg::SetParametersResult onSetIgains(
      const std::vector<rclcpp::Parameter> &parameters);

  rcl_interfaces::msg::SetParametersResult onSetDgains(
      const std::vector<rclcpp::Parameter> &parameters);

  rcl_interfaces::msg::SetParametersResult onDUseAccelFeedforward(
      const std::vector<rclcpp::Parameter> &parameters);

  rcl_interfaces::msg::SetParametersResult onDUseAccelEstimation(
      const std::vector<rclcpp::Parameter> &parameters);

  TwistPIDControl *controller_;
  ...
  rclcpp::node_interfaces::OnSetParametersCallbackHandle::SharedPtr
      d_use_accel_estimation_cb_handle_;
...
#endif  // BLUEROV_CTRL_TWIST_PID_INTERFACE_HPP
