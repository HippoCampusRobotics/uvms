...
class AttSkewSymmetricPControlModule {
 public:
   ...
   * @return Eigen::Vector3d Desired angular velocity for cascaded controller in
   * body-frame
   */
 ...
 private:
  ...
  Eigen::Vector3d v_angular_target_{
      0.0, 0.0, 0.0};  //!< angular velocity target in global frame
  Eigen::DiagonalMatrix<double, 3> att_mask_{
