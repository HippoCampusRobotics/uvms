...
namespace uvms_visualization {
    ...
    public:
        ...
        virtual void initialize(rclcpp::Node* node_ptr, visualization_msgs::msg::MarkerArray::SharedPtr marker_ptr) = 0;
    ...
    public:
        ...
        void initialize(rclcpp::Node* node_ptr, visualization_msgs::msg::MarkerArray::SharedPtr marker_ptr) override;
    ...
    public:
        TargetVisualization(){};
        virtual void initialize(rclcpp::Node* node_ptr, visualization_msgs::msg::MarkerArray::SharedPtr marker_ptr) override;
        void initializeMarkers() override;
    ...
    private:
        ...
        rclcpp::Subscription<uvms_msgs::msg::UVMSControlTarget>::SharedPtr uvms_target_sub_;
    ...
    public:
        ...
        void initializeMarkers() override;
    private:
        void onVelocityTarget(const hippo_msgs::msg::VelocityControlTarget::SharedPtr msg);
        rclcpp::Subscription<hippo_msgs::msg::VelocityControlTarget>::SharedPtr velocity_target_sub_;
    };
    ...
    private:
        ...
        rclcpp::Subscription<hippo_msgs::msg::ActuatorSetpoint>::SharedPtr thrust_sub_;
    };
