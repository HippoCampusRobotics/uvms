...
def main():
    ...
    for j in range(N_weight):
        axes[0].plot(a22, dx_w[j, :,idx_activation], c=c_mum[j], label="w" + str(idx_weighting+1) + str(idx_weighting+1) + ": " + str(p22[j]))
    ...
    for j in range(N_weight):
        axes[1].plot(a22, dq_w[j, :, idx_weighting], c=c_mum[j], label="w" + str(idx_weighting+1) + str(idx_weighting+1) + ": " + str(p22[j]))
    axes[1].set_xlabel("activation value a(2,2)")
    for i in range(n_states):
    ...
    for j in range(N_weight):
        axes[0].plot(a22, dx_p[j, :,idx_activation], c=c_mum[j], label="w" + str(idx_weighting+1) + str(idx_weighting+1) + ": " + str(p22[j]))
    axes[-1].set_xlabel("activation value a(2,2)")
    ...
    for j in range(N_weight):
        axes[1].plot(a22, dq_p[j, :, idx_weighting], c=c_mum[j], label="w" + str(idx_weighting+1) + str(idx_weighting+1) + ": " + str(p22[j]))
    axes[1].set_xlabel("activation value a(2,2)")
    for i in range(n_states):
    ...
    for j in range(N_weight):
        axes[0].plot(a22, dx_wp[j, :,idx_activation], c=c_mum[j], label="w" + str(idx_weighting+1) + str(idx_weighting+1) + ": " + str(p22[j]))
    axes[-1].set_xlabel("activation value a(2,2)")
    ...
    for j in range(N_weight):
        axes[1].plot(a22, dq_wp[j, :, idx_weighting], c=c_mum[j], label="w" + str(idx_weighting+1) + str(idx_weighting+1) + ": " + str(p22[j]))
    axes[1].set_xlabel("activation value a(2,2)")
    for i in range(n_states):
