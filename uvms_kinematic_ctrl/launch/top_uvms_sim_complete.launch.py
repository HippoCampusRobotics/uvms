...
def generate_launch_description():
    ...
    bluerov_ctrl = launch.actions.IncludeLaunchDescription(
        ...
        launch_arguments={
            ...
            str(4),
            'config_file':
            str(bluerov_ctrl_path / 'config/ctrl_params_sim_uvms.yaml'),
        }.items())
    ...
    return launch.LaunchDescription([
        alpha_estimation, alpha_force_torque_calc,
        bluerov_acceleration_estimation, bluerov_ctrl, bluerov_mixer,
        uvms_kinematic_ctrl, estimation_drift_watchdog, uvms_trajectory_gen,
        uvms_visualization, rviz
    ])
