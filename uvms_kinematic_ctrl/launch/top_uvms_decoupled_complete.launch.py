...
def generate_launch_description():
    ...
    bluerov_pose_ctrl = launch.actions.IncludeLaunchDescription(
        ...
        launch_arguments={
            ...
            'vehicle_name': vehicle_name,
            'config_file':
            str(bluerov_ctrl_path / 'config/ctrl_params_real.yaml'),
        }.items())
    ...
    return launch.LaunchDescription([
        *alpha_control, alpha_estimation, alpha_force_torque_calc,
        bluerov_acceleration_estimation, bluerov_pose_ctrl,
        bluerov_velocity_ctrl, bluerov_mixer, estimation_drift_watchdog,
        state_publisher, tf_publisher_vehicle, uvms_visualization, rviz
    ])
