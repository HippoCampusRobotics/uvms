...
def generate_launch_description():
    ...
    bluerov_pose_ctrl = launch.actions.IncludeLaunchDescription(
        launch.launch_description_sources.PythonLaunchDescriptionSource(
            str(bluerov_ctrl_path /
                "launch/node_pose_control_module.launch.py")),
        launch_arguments={
            'use_sim_time': str(use_sim_time),
            'vehicle_name': vehicle_name,
            'config_file':
            str(bluerov_ctrl_path / 'config/ctrl_params_sim.yaml'),
        }.items())
    ...
    return launch.LaunchDescription([
        *alpha_traj_gen, *alpha_control, bluerov_traj_gen, alpha_estimation,
        alpha_force_torque_calc, bluerov_acceleration_estimation,
        bluerov_pose_ctrl, bluerov_velocity_ctrl, bluerov_mixer,
        estimation_drift_watchdog, uvms_visualization, rviz
    ])
