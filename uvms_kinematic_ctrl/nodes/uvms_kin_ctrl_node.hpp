...
#ifndef UVMS_KINEMATIC_CTRL_UVMS_KIN_CTRL_NODE_H
#define UVMS_KINEMATIC_CTRL_UVMS_KIN_CTRL_NODE_H
...
namespace uvms_kin_ctrl {
    ...
    class UVMSKinematicControlNode : public rclcpp::Node {
    public:
        UVMSKinematicControlNode();
    ...
    private:
        ...
        void onSetpointTargetPrediction(const uvms_msgs::msg::ControlTargetPrediction::SharedPtr _msg);
        ...
        rclcpp::Subscription<sensor_msgs::msg::JointState>::SharedPtr state_sub_manipulator_;
        ...
        rclcpp::Subscription<uvms_msgs::msg::ControlTargetPrediction>::SharedPtr eef_traj_sub_prediction_;
        bool use_prediction_ = false;

        UVMSKinematicConfigurationControl* startup_controller_;
...
#endif //UVMS_KINEMATIC_CTRL_UVMS_KIN_CTRL_NODE_H
