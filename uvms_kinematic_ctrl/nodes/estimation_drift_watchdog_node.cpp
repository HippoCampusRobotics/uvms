    ...
    private:
        ...
        void initSubscriptions() {
            ...
            eef_pose_sub_ = create_subscription<geometry_msgs::msg::PoseStamped>(
                    topic, qos, std::bind(&EstimationWatchdogNode::onEndeffectorPose, this, _1));
            ...
            if (_msg->header.frame_id != hippo_common::tf2_utils::frame_id::kInertialName) {
                RCLCPP_WARN_THROTTLE(
                        ...
                        ("Target frame is " + _msg->header.frame_id + "but only " +
                         hippo_common::tf2_utils::frame_id::kInertialName + "is handled. Ignoring...").c_str());
                return;
            }
        ...
        void onEndeffectorPose(const geometry_msgs::msg::PoseStamped::SharedPtr _msg) {
            if (!got_first_setpoint_) {
                return;
            }
